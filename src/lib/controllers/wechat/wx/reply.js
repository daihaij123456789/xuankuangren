...
var help = '欢迎订阅大海休闲\n' +
			...
			'回复语音,使用语音查询信息<a href="http://www.xuankuangren.com/voiceMovie">华南选矿技术网</a>\n' +
			'点击 <a href="http://www.xuankuangren.com/">华南选矿技术网</a>';
			...
			if(message.EventKey === 'movie_hot'){
				...
				movies.forEach(function(movie){
					...
					news.push({
							...
							picUrl: movie.poster,
							url: 'http://www.xuankuangren.com/wechat/movie/' + movie._id
						});
				})
				...
				musics.forEach(function(muisc,index){
						news.push({
							...
							picUrl: muisc.image,
							url: 'http://www.xuankuangren.com/wechat/music/' + muisc._id
						});
				})
					...
					musics.forEach(function(music, index){
						if (index < 6) {
							reply.push({
								...
								picUrl: music.image,
								url: 'http://www.xuankuangren.com/wechat/music/' + music._id
							});
						}
					})
				}else{ 
