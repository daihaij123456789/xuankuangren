...
exports.guess = co.wrap(function* (ctx, next){
	...
	var url = 'http://www.xuankuangren.com'+ctx.url;
...
exports.jumpMovie = co.wrap(function* (ctx, next){
	...
	var redirectUrl = 'http://www.xuankuangren.com/wechat/movie/' + movieId
...
exports.jumpMusic = co.wrap(function* (ctx, next){
	...
	var redirectUrl = 'http://www.xuankuangren.com/wechat/music/' + musicId
